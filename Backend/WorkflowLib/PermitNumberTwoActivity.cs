...
public sealed class PermitNumberTwoActivity : ActivityBase
{
    public PermitNumberTwoActivity()
    {
        Type = "PermitNumberTwoActivity";
        Title = "DDOT Permit Two";
        Description = "Permit Number Two - Test";

        // the file name with your form template, without extension
        Template = "permitNumberTwoActivity";
        // the file name with your svg template, without extension
        SVGTemplate = "PermitNumberTwoActivity";
    }
