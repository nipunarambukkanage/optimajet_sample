...
{
    private const string ConnectionString = "Server=ddot-mps-sql-srv-development.database.windows.net;Database=MPS_OPTIMAJET_DEV_TEMP;User Id=sqladmin;Password=H@Sh1CoR3!";
    ...
    private static WorkflowRuntime InitWorkflowRuntime()
    {
        ...
        var runtime = new WorkflowRuntime()
            ...
            .WithCustomActivities(new List<ActivityBase> {
                        new WeatherActivity(),
                        new PermitNumberOneActivity(),
                        new PermitNumberTwoActivity(),
                        new PermitNumberThreeActivity(),
                        new PermitNumberFourActivity(),
            })
